...
require(knitr)
opts_chunk$set(fig.path = "images/eventDetection-")
```
# Event Detection
...
```{r baseLapChart,fig.cap="Example lap chart",message=FALSE,warning=FALSE}
library(ggplot2)
...
```{r baseLapChartZoom,fig.cap="Zooming in to a particular are of the lap chart - laps 16 and 17",warning=FALSE}
...
```{r  twoLapGraph, fig.cap="Network diagram showing position changes across two laps."}
...
```{r lapchart3laps,fig.cap="A view of position changes over laps",warning=FALSE,message=FALSE}
...
```{r multiLapGraph, fig.cap="Network diagram showing position changes across three laps."}
par(bg="white")
