...
opts_chunk$set(fig.path = "images/churn-")
...
```
```{r echo=FALSE}
kable(churn.df,format='markdown')
```

One way of displaying this tabular information graphically is to use bar charts.

```{r churnExampleBar, fig.cap="Bar charts showing churn and adjusted churn values for races in the 2013 season",message=FALSE,warning=FALSE}
library(ggplot2)
library(gridExtra)
...
```{r churnExampleLine,fig.cap="Line charts showing churn and adjusted churn values for races in the 2013 season. A loess model fit line suggests a highly uncertain/weak decreasing trend in churn (that is, loss of competitiveness) over the course of the season",message=FALSE}
...
```{r multichurnBar,fig.cap="Various churn values calculated for each race of the 2013 season."}
ggplot(churnData) + geom_bar(aes(x=round, y=value, fill=variable),
                             stat='identity', position='dodge')
```

```{r multiadjchurnBar,fig.cap="Various adjusted churn values calculated for each race of the 2013 season."}
...
```{r driveryearschurn,fig.cap="Churn in the Drivers' Championship standings, 1950-2014",message=FALSE}
...
```{r driveryearspointschurn,fig.cap="Churn in the Drivers' Championship standings for points scorers, 1950-2014",message=FALSE}
...
```{r driveryearstop10churn,fig.cap="Churn in the top 10 placed drivers of the Drivers' Championship standings, 1950-2014",message=FALSE}
...
```{r constructorChurn, fig.cap="Churn in Constructors' Championship standings, 1958-2014", message=FALSE}
