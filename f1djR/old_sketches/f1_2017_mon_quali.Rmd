---
title: "F1 2017 Monaco, Qualifying"
output:
  html_document:
    self_contained: yes
---
...
opts_chunk$set(fig.path = "images/f1_2017_mon-")
```

```{r}
library(f1djR)
gp="Monaco"
qlaps= read.csv("~/Dropbox/various/mon17_qualilaptimes.csv")
cutoff=c(15,10,2)
```
