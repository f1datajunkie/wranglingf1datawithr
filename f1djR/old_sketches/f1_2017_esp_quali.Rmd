---
title: "F1 2017 Spain, Qualifying"
output:
  html_document:
    self_contained: yes
---
...
opts_chunk$set(fig.path = "images/f1_2017_esp-")
```

```{r}
library(f1djR)
gp="Spanish"
qlaps= read.csv("~/Dropbox/various/esp17_qualilaptimes.csv")
cutoff=c(15,10,2)
```
