---
title: "F1 2017 Azerbaijan, Qualifying"
output:
  html_document:
    self_contained: yes
---
...
opts_chunk$set(fig.path = "images/f1_2017_azb-")
```

```{r}
library(f1djR)
gp="Azerbaijan"
qlaps= read.csv("~/Dropbox/various/azb17_qualilaptimes.csv")
cutoff=c(15,10,2)
```
